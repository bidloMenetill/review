      ...
      <div className='mx-auto max-w-[90%] xl:container pt-[100px] pb-[66px]'>
        ...
        >
          <div className='mt-[65px] flex gap-x-3'>
            <SwiperSlide
              className='bg-cover bg-no-repeat   flex-col rounded-[30px] !w-[600px] xl:!w-[860px] lg:!w-[700px] !h-[370px] xl:!h-[450px]'
            ...
            <SwiperSlide
              className='bg-cover bg-no-repeat  !flex justify-center items-center flex-col rounded-[30px] !w-[600px] xl:!w-[860px] lg:!w-[700px] !h-[370px] xl:!h-[450px]'
            ...
            <SwiperSlide
              className='bg-cover bg-no-repeat  !flex justify-center items-center rounded-[30px] !w-[600px] xl:!w-[860px] lg:!w-[700px] !h-[370px] xl:!h-[450px]'
