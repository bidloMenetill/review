...
export const IntrodactionSectionAboutUs = () => {
  ...
  return (
    <section className='bg-[url("/src/shared/img/about/about1.png")] font-normal text-7xl text-[#F5F5F5] pt-14 max-w-[1720px] leading-[100px] max-w-[1920px] xl:min-h-[960px] xl:min-w-[1720px] lg:min-w-[1300px]'>
