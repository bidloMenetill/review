...
export const Team = () => {
  ...
  const { aboutUsArtist, getAboutUsArtist } = useZustandStore();
  ...
  return (
    <>
      <section className='bg-[url("/src/shared/img/aboutMobile/bg_section_2.png")] max-w-[1920px] bg-cover bg-no-repeat flex min-h-[1159px]'>
        <div className='tablet:max-w-[99%] flex flex-col justify-center text-center tablet:text-left items-center gap-y-12 mx-auto'>
          <h2
          ...
          <p className='max-w-full sm:max-w-full text-dm sm:text-2xl sm:text-center font-medium leading-6 sm:leading-10 text-slate-100 xl:max-w-[1500px] px-[3%]'>
            {aboutUsTeam[1]?.description}
          </p>
          <ul className='flex flex-wrap gap-6 sm:flex-wrap sm:gap-y-36 items-center text-center xl:flex-row mx-auto tablet:max-w-[1700px] xl:pl-0 xl:pr-0 lg:flex-row lg:max-w-full justify-center lg:justify-center'>
