...
export const Team = () => {
  ...
  return (
    <>
      <div className='sm:min-w-[576px] md:min-w-[768px] lg:min-w-[1300px] xl:min-w-[1920px] min-h-[2000px]'>
        <div className='w-11/12 sm:w-11/12 md:w-11/12 lg:w-11/12 xl:w-11/12 flex flex-col gap-y-24 mx-auto'>
          ...
          <div className='w-full flex flex-col flex-wrap gap-y-36 lg:gap-y-20 lg:pb-6 xl:gap-y-36'>
            {teams.map((team, index) => (
              <div className='w-11/12 sm:w-11/12 md:w-11/12 lg:pt-36 flex lg:gap-7 lg:w-11/12 xl:pt-40 xl:gap-8 xl:w-11/12'>
                <img
