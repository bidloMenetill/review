...
export const ServiceLinks = () => {
  ...
  return (
    <section className='relative w-full h-[490px] tablet:h-[1900px] lg:h-[2050px] xl:h-[2500px] text-[#F5F5F5]'>
      <img
      ...
      <div className='mx-auto pt-[20px] w-[335px] mb-[232px] xl:pt-[100px] xl:w-[1720px] lg:w-[1200px]'>
        ...
        {arrayLinks?.map((item, index) => (
          <div
            key={index}
            className='w-full h-[120px] lg:h-[500px] xl:h-[600px] bg-[rgba(0,0,0,0.60)] border-[1px] border-solid border-[#7a7a7a] rounded-[6px] lg:rounded-[30px] flex justify-between px-[10px] py-[12px] mb-[10px] lg:px-[60px] lg:py-[58px] lg:mb-[70px]'
          >
            <img
