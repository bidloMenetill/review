export const Button = ({
  ...
  const styles = {
    ...
    serviceButton:
      'sm:w-auto sm:h-auto text-center font-[300] rounded-[500px] text-[12px] py-[10.5px] px-[30px] tablet:text-[28px] lg:rounded-[50px] bg-[#F93822] font-normal sm:text-[20px] tablet:text-[20px] lg:text-[26px] xl:text-[30px] text-[#F5F5F5] lg:py-[18px] xl:py-[14px] lg:px-[60px] xl:px-[75px] transition-all duration-300 hover:opacity-80',
  };
